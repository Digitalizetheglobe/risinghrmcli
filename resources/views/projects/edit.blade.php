...
{{ Form::model($project, ['route' => ['projects.update', $project->id], 'method' => 'PUT', 'id' => 'projectForm', 'class' => 'needs-validation', 'novalidate' => 'novalidate', 'enctype' => 'multipart/form-data']) }}
@csrf
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::date('project_startdate', $project->project_startdate ? \Carbon\Carbon::parse($project->project_startdate)->format('Y-m-d') : null, ['class' => 'form-control', 'required' => 'required', 'autocomplete' => 'off']) }}
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::date('project_enddate', $project->project_enddate ? \Carbon\Carbon::parse($project->project_enddate)->format('Y-m-d') : null, ['class' => 'form-control', 'required' => 'required', 'autocomplete' => 'off']) }}
                </div>
            </div>
        </div>
        ...
        <input type="hidden" name="assigned_data" id="assignedData" value="{{ json_encode($project->assigned_data) }}">
...
$(document).ready(function() {
    ...
    $('#department_id').change(function() {
        ...
        if (!departmentId) {
            $('#employee_id').html('<option value="">{{ __("Select Employee") }}</option>');
            return;
        }
