...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select name="brances" id="brances" required class="form-control ">
                    <option selected disabled value="0"><?php echo e(__('Select Category')); ?></option>
        ...
        <div class="col-md-6 mt-2">
            <div class="form-group">
                <?php echo e(Form::label('employee', __('Employee'), ['class' => 'form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('appraisal_date', __('Select Month'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
...
<?php /**PATH C:\xampp\htdocs\hrm\resources\views/appraisal/create.blade.php ENDPATH**/ ?>