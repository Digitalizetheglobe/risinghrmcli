    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('amount', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Amount')])); ?>
...
<?php /**PATH C:\xampp\htdocs\hrm\resources\views/expense/create.blade.php ENDPATH**/ ?>