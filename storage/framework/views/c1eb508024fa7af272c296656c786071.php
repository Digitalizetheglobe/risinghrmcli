                            ...
                            <li class="dash-item dash-hasmenu">
                                ...
                                <ul class="dash-submenu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Report')): ?>
                                        ...
                                        <li class="dash-item">
                                            <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" 
                                            href="<?php echo e(route('report.timesheet')); ?>">
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage TimeSheet')): ?>
                            <li class="dash-item">
                                <a class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg" href="<?php echo e(route('timesheet.index')); ?>"><?php echo e(__('Timesheet')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Attendance')): ?>
                            <li class="dash-item dash-hasmenu">
                                <a href="#!" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg"><span
...
<?php /**PATH /home/u704145757/domains/connect360.in/public_html/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>