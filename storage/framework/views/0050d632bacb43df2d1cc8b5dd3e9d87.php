...
<?php $__env->startSection('action-button'); ?>
    ...
    <div class="col-md-12 text-end d-flex ">
        ...
        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
            <a href="<?php echo e(route('send.mail.contract', $contract->id)); ?>" class="btn btn-sm btn-primary btn-icon m-2"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Contract')): ?>
                ...
                <a href="#" data-size="lg" data-url="<?php echo e(route('contracts.copy', $contract->id)); ?>"data-ajax-popup="true"
                    data-title="<?php echo e(__('Duplicate')); ?>" class="btn btn-sm btn-primary btn-icon m-2" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="<?php echo e(__('Duplicate')); ?>"><i class="ti ti-copy text-white"></i></a>
            <?php endif; ?>
        <?php endif; ?>
        ...
        <a href="<?php echo e(route('get.contract', $contract->id)); ?>" target="_blank" class="btn btn-sm btn-primary btn-iconn m-2"
        ...
        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
            <a href="#" class="btn btn-sm btn-primary btn-icon m-2"
                ...
                data-title="<?php echo e(__('Signature')); ?>" data-size="md" title="<?php echo e(__('Signature')); ?>" data-bs-toggle="tooltip"
                data-bs-placement="top">
                <i class="ti ti-writing-sign"></i>
            </a>
        <?php elseif(\Auth::user()->type == 'employee' && $contract->status == 'accept'): ?>
            <a href="#" class="btn btn-sm btn-primary btn-icon m-2"
                data-url="<?php echo e(route('signature', $contract->id)); ?>" data-ajax-popup="true"
                data-title="<?php echo e(__('Signature')); ?>" data-size="md" title="<?php echo e(__('Signature')); ?>" data-bs-toggle="tooltip"
                data-bs-placement="top">
                            ...
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                ...
                                <a href="#attachments"
                                    class="list-group-item list-group-item-action border-0"><?php echo e(__('Attachment')); ?> <div
                                        class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#comment"
                                    class="list-group-item list-group-item-action border-0"><?php echo e(__('Comment')); ?> <div
                                        class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#notes"
                                        ...
                                        <div class="card-body pt-0 ">
                                            <address class="mb-0 text-sm">
                                                <div class="row mt-3 align-items-center">
                                                    ...
                                                    <div class="col-sm-8 text-sm"><?php echo e($contract->contract_type->name); ?>

                                                    </div>

                                                    <div class="col-sm-4 h6 text-sm"><?php echo e(__('Value')); ?></div>
                                                    <div class="col-sm-8 text-sm">
                                                        <?php echo e(Auth::user()->priceFormat($contract->value)); ?></div>

                                                    <div class="col-sm-4 h6 text-sm"><?php echo e(__('Start Date')); ?></div>
                                                    <div class="col-sm-8 text-sm">
                                                        <?php echo e(Auth::user()->dateFormat($contract->start_date)); ?></div>

                                                    <div class="col-sm-4 h6 text-sm"><?php echo e(__('End Date')); ?></div>
                                                    <div class="col-sm-8 text-sm">
                                                        <?php echo e(Auth::user()->dateFormat($contract->end_date)); ?></div>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-3">
                                            <textarea class="summernote-simple" name="contract_description" id="contract_description" rows="3"><?php echo $contract->contract_description; ?></textarea>
                                        </div>
                                    </div>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Contract')): ?>
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Attachment')): ?>
                                                                    <?php if(\Auth::user()->id == $file->user_id || \Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
                                                    ...
                                                    <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
                                                        <div class="form-group mb-0 form-send w-100">
                                                            <input type="hidden" id="commenturl"
                                                                value="<?php echo e(route('comment.store', $contract->id)); ?>">
                                                            ...
                                                            <div class="list-group-item ">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Comment')): ?>
                                                                        <?php if(\Auth::user()->id == $comment->user_id || \Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
                                                            ...
                                                            <div class="list-group-item ">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Note')): ?>
                                                                        <?php if(\Auth::user()->id == $note->user_id || \Auth::user()->type == 'company' || \Auth::user()->type == 'hr'): ?>
                                                                            <div class="p-0 w-auto action-btn bg-danger">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm\resources\views/contracts/show.blade.php ENDPATH**/ ?>