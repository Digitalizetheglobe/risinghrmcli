...
<div class="modal-body px-50">
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo Form::select('presale_employee_id', $allEmployees, null, [
                'class' => 'form-control select2',
...
$('#choices-multiple').on('change', function() {
    ...
    if (!userId) {
        ...
        refreshProjectDropdown(<?php echo json_encode($projects, 15, 512) ?>);
        return;
    }
...
</script><?php /**PATH C:\xampp\htdocs\hrm\resources\views/timeSheet/create.blade.php ENDPATH**/ ?>