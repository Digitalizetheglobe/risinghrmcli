                    ...
                    <div class="apply-job-wrapper bg-light">
                        ...
                        <div class="apply-job-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('email', __('Email'), ['class' => 'form-label'])); ?><span class="text-danger pl-1">*</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('phone', __('Phone'), ['class' => 'form-label'])); ?><span class="text-danger pl-1">*</span>
                                ...
                                <?php if(!empty($job->visibility) && in_array('terms', explode(',', $job->visibility))): ?>
                                    <div class="form-group col-md-12 ">

                                        <div class="form-check custom-checkbox">
                                            <input type="checkbox" class="form-check-input" id="termsCheckbox" name="terms_condition_check" required>
                                            <label class="form-check-label" for="termsCheckbox"><?php echo e(__('Accept')); ?>

                                                <a href="<?php echo e(route('terms-and-conditions', [$job->id])); ?>"
...
<?php /**PATH D:\risinghrmcli\resources\views/job/apply.blade.php ENDPATH**/ ?>