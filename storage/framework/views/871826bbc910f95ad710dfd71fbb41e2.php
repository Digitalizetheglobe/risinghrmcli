                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="is_deducted" required>
                                <option value="1" <?php echo e($deduction->is_deducted ? 'selected' : ''); ?>>
                                    <?php echo e(__('Yes, deduct as scheduled')); ?>

                                </option>
                                <option value="0" 
                                    <?php echo e($deduction->remark === 'No Deduction' ? 'disabled selected' : ''); ?>

                                    <?php echo e(!$deduction->is_deducted && $deduction->remark !== 'No Deduction' ? 'selected' : ''); ?>>
                                    <?php echo e($deduction->remark === 'No Deduction' ? 'Already marked as No Deduction' : __('No, defer this deduction')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\risinghrmcli\resources\views/loan/edit_deduction.blade.php ENDPATH**/ ?>