                                ...
                                <?php $__currentLoopData = $loan->deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            ...
                                            <?php if($deductionMonth > $originalEndMonth): ?>
                                                <span class="badge bg-info ms-2">Extended</span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e(\Auth::user()->priceFormat($deduction->emi_amount)); ?></td>
                                        <td>
                                            <?php if($deduction->remark === 'No Deduction'): ?>
                                                <span class="badge bg-danger"><?php echo e(__('No Deduction')); ?></span>
                                            <?php elseif($deduction->is_deducted): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\risinghrmcli\resources\views/loan/show.blade.php ENDPATH**/ ?>