...
<div class="modal-body">
    ...
    <div class="card-footer text-end">
        <a href="#" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true"
            data-url="<?php echo e(route('generate', ['goaltracking'])); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('branch', __('Branch'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('goal_type', __('GoalTypes'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <?php echo e(Form::label('subject', __('Subject'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
...
<?php /**PATH C:\xampp\htdocs\hrm\resources\views/goaltracking/edit.blade.php ENDPATH**/ ?>