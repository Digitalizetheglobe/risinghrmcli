            ...
            <div class="col-md-12">
                <div class="card card-fluid">
                    <div class="card-body">
                        ...
                        <?php if(!empty($job->terms_and_conditions)): ?>
                            <div class="row">
                                <div class="col-12 mt-3">
                                    <h6><?php echo e(__('Terms and conditions')); ?></h6>
                                    <?php echo $job->terms_and_conditions; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm\resources\views/job/show.blade.php ENDPATH**/ ?>