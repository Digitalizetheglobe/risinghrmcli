...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                <?php echo e(Form::label('amount', __('Amount'), ['class' => 'form-label'])); ?><span class="text-danger pl-1">*</span>
                <div class="form-icon-user">
...
</script><?php /**PATH C:\xampp\htdocs\hrm\resources\views/assets/create.blade.php ENDPATH**/ ?>