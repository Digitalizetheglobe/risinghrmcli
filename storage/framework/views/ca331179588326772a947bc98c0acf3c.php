                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::date('dob', $employee->dob, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Select Date of Birth'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-icon-user">
                                            <?php echo e(Form::select('branch_id', $branches, $employee->branch_id, ['class' => 'form-control branch_id', 'id' => 'branch_id'])); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-icon-user designation_div">
                                            <?php echo e(Form::select('designation_id', $designations, $employee->designation_id, ['class' => 'form-control', 'id' => 'designation_id', 'placeholder' => 'Select Designation'])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('company_doj', $employee->company_doj, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Select company date of joining'])); ?>
                                            ...
                                            <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="row experience-detail-row mb-3">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <?php echo Form::date("experience[$key][start_date]", $experience['start_date'] ?? null, [
                                                            'class' => 'form-control',
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <?php echo Form::date("experience[$key][end_date]", $experience['end_date'] ?? null, [
                                                            'class' => 'form-control',
                                        ...
                                        <?php else: ?>
                                            <div class="row experience-detail-row mb-3">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <?php echo Form::text("experience[0][previous_designation]", $experience['previous_designation'] ?? null, [
                                                        'class' => 'form-control',
                                                        'placeholder' => 'Enter designation',
                                                    ]); ?>
...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var initialDesignation = '<?php echo e($employee->designation_id); ?>';
        ...
        function getDesignation(did) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var selectedDesignation = '<?php echo e($employee->designation_id); ?>';
    ...
    <script>
        ...
        $(document).ready(function() {
            let educationRowCount = <?php echo e(!empty($educations) ? count($educations) : 1); ?>;
            const allDegrees = ['10th', '12th', 'Bachelor', 'Master', 'PhD'];
            let usedDegrees = [];
            
            // Initialize used degrees from existing rows
            $('.degree').each(function() {
                if ($(this).val()) {
                    usedDegrees.push($(this).val());
                }
            });
            
            // Function to get available degrees
            function getAvailableDegrees() {
                return allDegrees.filter(function(degree) {
                    return !usedDegrees.includes(degree);
                });
            }
            
            // Function to update degree dropdowns
            function updateDegreeDropdowns() {
                ...
                $('.degree').each(function() {
                    ...
                    availableDegrees.forEach(function(degree) {
                        $(this).append('<option value="' + degree + '">' + degree + '</option>');
                    });
                    
                    // Add current value if it's already selected (for existing rows)
                    if (currentValue && !availableDegrees.includes(currentValue)) {
                        $(this).append('<option value="' + currentValue + '" selected>' + currentValue + '</option>');
                    }
                    
                    // If no available degrees, disable the dropdown
            ...
            // Track degree selection changes
            ...
            $('.add-education-row').click(function() {
                ...
                if (availableDegrees.length === 0) {
                    alert('All degree levels have already been added.');
                    return;
                }
                    ...
                    <div class="row education-detail-row mb-3">
                        <div class="form-group col-md-6">
                            ...
                            <select name="education[${educationRowCount}][degree]" class="form-control degree">
                                ${availableDegrees.map(function(degree) { 
                ...
                // Update used degrees and dropdowns
                usedDegrees = [];
                $('.degree').each(function() {
                    if ($(this).val()) {
                        usedDegrees.push($(this).val());
            ...
            $(document).on('click', '.remove-education-row', function() {
                const removedDegree = $(this).closest('.education-detail-row').find('.degree').val();
                $(this).closest('.education-detail-row').remove();
                
                // Update used degrees and dropdowns
                if (removedDegree) {
                    usedDegrees = usedDegrees.filter(function(degree) {
                        return degree !== removedDegree;
                    });
                }
                updateDegreeDropdowns();
            });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\risinghrmcli\resources\views/employee/edit.blade.php ENDPATH**/ ?>