    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('from_account_id', __('From Account'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('to_account_id', __('To Account'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::date('date', null, ['class' => 'form-control current_date', 'autocomplete' => 'off'])); ?>

            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('amount', __('Amount'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
...
<?php /**PATH C:\xampp\htdocs\hrm\resources\views/transferbalance/create.blade.php ENDPATH**/ ?>