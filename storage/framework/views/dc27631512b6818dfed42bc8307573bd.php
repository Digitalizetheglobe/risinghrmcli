                            ...
                            <tbody>
                                <?php $__currentLoopData = $attendanceEmployee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo breakAfterWords($attendance->clock_in_location); ?></td>
                                        <td><?php echo e($attendance->clock_out != '00:00:00' ? \Auth::user()->timeFormat($attendance->clock_out) : '00:00'); ?>

                                        </td>
                                        <td><?php echo breakAfterWords($attendance->clock_out_location); ?></td>
...
<script>
    ...
    $('.export-btn').click(function() {
        ...
        var url = "<?php echo e(route('attendance.export')); ?>";
        url += "?type=" + type;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\risinghrmcli\resources\views/attendance/index.blade.php ENDPATH**/ ?>