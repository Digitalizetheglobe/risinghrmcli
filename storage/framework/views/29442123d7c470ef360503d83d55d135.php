...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <?php echo e(Form::label('title', __('Subject'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
            <?php echo e(Form::text('title', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Ticket Subject')])); ?>

        </div>
        <?php if(\Auth::user()->type != 'employee'): ?>
            <div class="form-group col-md-6">
                <?php echo e(Form::label('employee_id', __('Ticket for Employee'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="form-group col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('priority', __('Priority'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
...
<?php /**PATH C:\xampp\htdocs\hrm\resources\views/ticket/create.blade.php ENDPATH**/ ?>