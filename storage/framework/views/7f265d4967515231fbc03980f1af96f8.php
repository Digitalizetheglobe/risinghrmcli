...
<div class="modal-body">
    <div class="row">
        <div class="form-group">
            <?php echo e(Form::label('salary_type', __('Payslip Type'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <!-- <div class="form-group">
            <?php echo e(Form::label('account_type', __('From Account'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
...
<?php /**PATH D:\risinghrmcli\resources\views/setsalary/basic_salary.blade.php ENDPATH**/ ?>