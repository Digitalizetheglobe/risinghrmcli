            ...
            <div class="main-left-content">
                ...
                <div class="main-button-container">
                    <button class="main-btn main-red-btn">
                        <a href="<?php echo e(route('contact')); ?>" class="main-btn main-red-btn">REQUEST A DEMO</a>
                    </button>
                </div>
            </div>
            <!-- Right side image -->
            <div class="main-right-image">
                <img src="<?php echo e(asset('Modules/LandingPage/Resources/views/layouts/images/middel.png')); ?>" alt="Person with Laptop">
            </div>
            <!-- Close button -->
...
</html><?php /**PATH C:\xampp\htdocs\hrm\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>