                                            ...
                                            <span>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Resignation')): ?>
                                                    ...
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="<?php echo e(route('resignation.review', $resignation->id)); ?>" 
                                                        class="mx-3 btn btn-sm align-items-center" 
                                                        data-bs-toggle="tooltip" 
                                                        title="<?php echo e(__('Review')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\risinghrmcli\resources\views/resignation/index.blade.php ENDPATH**/ ?>