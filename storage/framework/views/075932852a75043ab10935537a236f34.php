<div class="container mx-auto p-4">
    <?php echo e(Form::open(['route' => ['booking.store']])); ?>
    ...
    <div id="step1" class="step">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <?php echo e(Form::text('primary_applicant_name', $bookingForm->primary_applicant_name ?? '', [
                    'class' => 'form-control required-field', 
                    'placeholder' => 'Enter Primary Applicant Name',
                    'required' => true
                ])); ?>

                <div class="invalid-feedback primary_applicant_name-error"></div>
            </div>
            <div class="form-group col-md-4">
                <?php echo e(Form::label('primary_applicant_contact_no', __('Primary Applicant Contact No.'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::text('primary_applicant_contact_no', $bookingForm->primary_applicant_contact_no ?? '', [
                    'class' => 'form-control required-field', 
                    'placeholder' => 'Enter Contact No.',
                    'required' => true
                ])); ?>

                <div class="invalid-feedback primary_applicant_contact_no-error"></div>
            </div>

            <div class="form-group col-md-4">
                <?php echo e(Form::label('primary_applicant_email', __('Primary Applicant Email'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::email('primary_applicant_email', $bookingForm->primary_applicant_email ?? '', [
                    'class' => 'form-control required-field', 
                    'placeholder' => 'Enter Email',
                    'required' => true
                ])); ?>

                <div class="invalid-feedback primary_applicant_email-error"></div>
            </div>
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <?php echo e(Form::text('secondary_applicant_name', '', ['class' => 'form-control', 'placeholder' => 'Enter Secondary Applicant Name'])); ?>

            </div>
            <div class="form-group col-md-4">
                <?php echo e(Form::label('secondary_applicant_contact_no', __('Secondary Applicant Contact No.'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::text('secondary_applicant_contact_no', '', ['class' => 'form-control', 'placeholder' => 'Enter Contact No.'])); ?>

            </div>
            <div class="form-group col-md-4">
                <?php echo e(Form::label('secondary_applicant_email', __('Secondary Applicant Email'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::email('secondary_applicant_email', '', ['class' => 'form-control', 'placeholder' => 'Enter Email'])); ?>
    ...
    <div id="step3" class="step hidden">
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <?php echo e(Form::text('confirm_total_cost', '', ['class' => 'form-control', 'id' => 'confirm_total_cost', 'readonly' => true])); ?>

            </div>
            <div class="form-group col-md-4">
                <?php echo e(Form::label('remaining', __('Remaining Amount (Rs)'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::text('remaining', $bookingForm->remaining ?? '', ['class' => 'form-control', 'id' => 'remaining', 'readonly' => true])); ?>

            </div>
            <div class="form-group col-md-4">
                <?php echo e(Form::label('total_paid', __('Total Paid Amount (Rs)'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::text('total_paid', '0', ['class' => 'form-control', 'id' => 'total_paid', 'readonly' => true])); ?>
        ...
        <div class="d-flex justify-content-start col-md-12 gap-3 mt-3 ">
            ...
            <input type="submit" value="<?php echo e(__('Create')); ?>" class="btn btn-primary mt-3">
        </div>
    </div>
...
<script>
    ...
    function calculateTotalCost() {
        const fields = [
            'rate_per_sq_ft', 'basic_cost', 'cost_infrastructure', 
            'gst', 'stamp_duty', 'registration', 'other',
            'maintenance_cost'
        ];
...
<?php /**PATH C:\xampp\htdocs\hrm\resources\views/booking/create.blade.php ENDPATH**/ ?>