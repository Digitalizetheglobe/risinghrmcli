    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <?php echo e(Form::label('account_id', __('Account'), ['class' => 'col-form-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('amount', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Amount'), 'step' => '0.01'])); ?>
...
<?php /**PATH C:\xampp\htdocs\hrm\resources\views/deposit/create.blade.php ENDPATH**/ ?>